...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="<?= base_url('galleries/bulk_action') ?>" method="POST" id="bulkForm">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle" width="100%" cellspacing="0">
                    ...
                    <tbody>
                            ...
                            foreach ($media as $m): ?>
                                <tr>
                                    <td class="text-center">
                                        <input type="checkbox" name="ids[]" class="checkItem" value="<?= $m->id ?>">
                                    </td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-center py-4">Belum ada media yang diunggah.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (checkAll) {
            // Ketika checkbox "Pilih Semua" diklik
            ...
            // (Opsional) Jika user manual uncheck satu baris, matikan "Pilih Semua"
            // Jika user manual centang semua baris satu per satu, hidupkan "Pilih Semua"
            checkItems.forEach(function(item) {
