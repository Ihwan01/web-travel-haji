...
<div class="contact-page">
    ...
    <div class="contact-main">
        ...
        <div class="contact-form-side">
            ...
            <?php
            // Ambil package dari query string jika ada
                    ...
                    <select id="package_interest" name="package_interest" class="form-select">
                        ...
                        <?php if (!empty($packages)): ?>
                            ...
                            <option value="<?= htmlspecialchars($pkg->name) ?>"
                                <?= ($selected_pkg === $pkg->name) ? 'selected' : '' ?>>
        ...
        <div class="contact-info-side reveal">
                ...
                <div class="contact-channels">
                    ...
                    <div class="contact-channel">
                        ...
                        <div>
                            ...
                            <p class="channel-value">+62 8xx-xxxx-xxxx</p>
                    ...
                    <div class="contact-channel">
                        ...
                        <div>
                            ...
                            <p class="channel-value">hello@nuansarindu.com</p>
                    ...
                    <div class="contact-channel">
                        ...
                        <div>
                            ...
                            <p class="channel-value">@nuansarindu</p>
            ...
            $wa_msg = urlencode('Assalamu\'alaikum, saya ingin berkonsultasi mengenai perjalanan Nuansa Rindu.');
            ?>
            <div>
                <a href="https://wa.me/<?= $wa_num ?>?text=<?= $wa_msg ?>"
                   class="wa-cta" target="_blank" rel="noopener">
...
function selectPackage(name) {
    ...
    // scroll ke form
    document.getElementById('consultForm').scrollIntoView({ behavior:'smooth', block:'center' });
}
</script>
